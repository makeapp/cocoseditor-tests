...
if (sys.platform == 'browser') {
    ...
    var ccb_resources = g_ressources.concat(g_sprites, g_menu, g_touches, g_fileUtils, g_s9s_blocks,
            g_opengl_resources, g_label, g_transitions, g_box2d, g_cocosdeshion, g_parallax, g_particle,
            g_fonts, g_extensions, g_performace, g_tilemaps
    )
    ...
    var Cocos2dXApplication = cc.Application.extend({
        ...
        applicationDidFinishLaunching: function ()
        {
            ...
            glView.setDesignResolutionSize(800, 600, cc.RESOLUTION_POLICY.SHOW_ALL);
